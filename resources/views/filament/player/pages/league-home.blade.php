<x-filament-panels::page>
    <div class="mx-auto w-full max-w-3xl px-4 py-6">
        <x-filament::section class="rounded-2xl border border-gray-200 dark:border-white/3">
            <div
                class="-mx-6 grid grid-cols-1 divide-y divide-gray-200 dark:divide-white/3
                  md:grid-cols-2 md:divide-y-0 md:divide-x">
                @foreach ($teams as $team)
                    <div class="p-6 flex flex-col items-center gap-3">
                        <h3 class="text-lg font-semibold">{{ $team->name }}</h3>
                        <div style="max-width: 150px"
                            class="grid place-items-center dark:border-white/3 overflow-hidden">
            ...
            <div class="-mx-6 border-t border-gray-200 dark:border-white/3 pt-3 text-center">
